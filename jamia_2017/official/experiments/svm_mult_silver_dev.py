...
print 'Getting data...',
data = setup_baseline_data(dataset='twitter', data_path='../twitter_data/', train_regime='silver', test_regime='silver', random_seed=random_seed)
...
t0 = time()
experiments = random_search(model, random_hyperparams, '../data/best_models_twitter/best_svm_mult_silver.pkl', **score_kwds)
print 'Done {}:{}:{} seconds. Writing out experiments'.format(*hms(time()-t0))
joblib.dump(experiments, '../data/dev_models_twitter/svm_mult_silver_dev.pkl')
print 'All done'
